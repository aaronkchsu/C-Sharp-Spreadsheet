...
-THERE IS LITTLE CHANGES MADE SUCH AS THE FUNCTION OF SAVE WORKING AND BEING ENABLED
AFTER A SAVE AS CALL
- THE CHANGED WAS ALSO MADE TO THE TESTS AT THSI POINT TO GET TESTS WORKING
- THERE IS REALLY COOL STYLES OF LEARNING ADDED TO THE POINT
-I also fixed the bug where when you try to exit and the save screen does not show the default types of files
